...
const SAVED_VIEWS: SavedView[] = [
  ...
  { id: "gov_va",        label: "Gov / VA",       sortBy: "name",       sortOrder: "asc",  filters: [], params: { govVa: "true" } },
  { id: "high_priority", label: "High Priority",  sortBy: "name",       sortOrder: "asc",  filters: [], params: { highPriority: "true" } },
